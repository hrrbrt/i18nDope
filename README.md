...
To build the final jar and optimize the i18nDope application for production, run:
...
Then navigate to [http://localhost:12000](http://localhost:12000) in your browser.
