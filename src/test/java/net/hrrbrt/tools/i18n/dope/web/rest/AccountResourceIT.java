package net.hrrbrt.tools.i18n.dope.web.rest;

import static net.hrrbrt.tools.i18n.dope.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.hrrbrt.tools.i18n.dope.IntegrationTest;
import net.hrrbrt.tools.i18n.dope.config.Constants;
import net.hrrbrt.tools.i18n.dope.domain.User;
import net.hrrbrt.tools.i18n.dope.repository.AuthorityRepository;
import net.hrrbrt.tools.i18n.dope.repository.UserRepository;
import net.hrrbrt.tools.i18n.dope.security.AuthoritiesConstants;
import net.hrrbrt.tools.i18n.dope.service.UserService;
import net.hrrbrt.tools.i18n.dope.service.dto.AdminUserDTO;
import net.hrrbrt.tools.i18n.dope.service.dto.PasswordChangeDTO;
import net.hrrbrt.tools.i18n.dope.service.dto.UserDTO;
import net.hrrbrt.tools.i18n.dope.web.rest.vm.KeyAndPasswordVM;
import net.hrrbrt.tools.i18n.dope.web.rest.vm.ManagedUserVM;
